...
//        }
        ...
        cubeLocation = Vision.readBallPattern(mRgba.getNativeObjAddr(),sample1X, sample2X, sample3X,sampleY);
...
//        }
    ...
    private static double sampleY = 240;
    ...
    public static double getSampleY() { return sampleY; }
    ...
    public static void setSampleY(double y) {sampleY = y;}
