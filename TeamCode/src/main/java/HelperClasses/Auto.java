...
import static org.firstinspires.ftc.robotcontroller.Vision.FtcRobotControllerVisionActivity.getSampleY;
...
public class Auto extends Robot {
    ...
    public void ControlSampleLocations() {
        ...
        if(ButtonPress.isGamepad1_dpad_down_pressed()){
            FtcRobotControllerVisionActivity.setSampleY(FtcRobotControllerVisionActivity.getSampleY() + shiftAmount);
        }
        ...
        telemetry.addLine("SampleY: " + getSampleY());
