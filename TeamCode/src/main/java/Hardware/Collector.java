...
public class Collector extends Extension{
    ...
    private final double DUMPER_RESET_TIME = 20;//opposite of above


    /**absolute servo position of the activated position*/
    public double TILT_ACTIVATED_POS = 0.035;
...
//            myRobot.telemetry.addLine("CollectorDumperPercent: " + getTiltPercent());
     ...
     */
    private static double TIME_TO_DEPLOY_COLLECTOR = 0.275;
    ...
    public boolean deployWhenOverCrater() {
        ...
        double howFarTheCollectorWillTravelDuringDeploy =
                (SpeedOmeter.getSpeedY() + getExtensionCurrSpeed())
        ...
        double targetDeployAddition = 6;//positive makes it deploy earlier, negative is later
